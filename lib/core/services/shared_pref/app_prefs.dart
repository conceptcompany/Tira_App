...
const String tokenAuthKey = "tokenAuthKey";
...
class AppPreferences {
  ...
  Future<void> setAuthToken(String token) async {
    _sharedPreferences.setString(tokenAuthKey, 'Bearer $token');
  }
  ...
  String? get jwtToken => _sharedPreferences.getString(tokenAuthKey) ?? '';
  bool? get isLogin =>
